    ...
    <div class="col-1-of-3">
        <div class="card">
            <div class="card__side card__side--front">
                ...
                <h4 class="card__heading">
                    <span class="card__heading-span card__heading-span--2">Arc Development</span>                                 
                </h4>
                <div class="card__details">
                    <ul>
                        <li>7 day tour</li>
    ...
    <div class="col-1-of-3">
        <div class="card">
            <div class="card__side card__side--front">
                ...
                <h4 class="card__heading">
                    <span class="card__heading-span card__heading-span--1">Crown Clothing</span>                                 
                </h4>
                <div class="card__details">
                    <ul>
                        <li>React JavaScript</li>
    ...
    <div class="col-1-of-3">
        <div class="card">
            <div class="card__side card__side--front">
                ...
                <h4 class="card__heading">
                    <span class="card__heading-span card__heading-span--2">My Portfolio</span>                                 
                </h4>
                <div class="card__details">
                    <ul>
                        <li>7 day tour</li>
    ...
    <div class="col-1-of-3">
        <div class="card">
            <div class="card__side card__side--front">
                ...
                <h4 class="card__heading">
                    <span class="card__heading-span card__heading-span--3">Chat Application</span>                                 
                </h4>
                <div class="card__details">
                    <ul>
                        <li>5 day tour</li>
